...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { cliente_id: @contato.cliente_id, numero: @contato.numero } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { cliente_id: @contato.cliente_id, numero: @contato.numero } }
