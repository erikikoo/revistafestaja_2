...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { cliente_id: @endereco.cliente_id, complemento: @endereco.complemento, end: @endereco.end, numero: @endereco.numero } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { cliente_id: @endereco.cliente_id, complemento: @endereco.complemento, end: @endereco.end, numero: @endereco.numero } }
